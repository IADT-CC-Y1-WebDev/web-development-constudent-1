...
<body>
    ...
    <div class="output">
     ...
     // TODO: Write your solution here
        ...
        function addPoints($points) {
            ...
            echo "<p>Added $points points. Total is now: $totalPoints</p>";
        }
    ...
    <div class="output">
        ...
        function testScope() {
            $message = "Local"; 
            echo "<p>Inside function: message is $message</p>";
        }
        testScope();
        echo "<p>Outside function: message is $message</p>";
